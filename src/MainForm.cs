...
namespace SharpBrowser {
    ...
    internal partial class MainForm : Form {
        ...
        public bool VanderaC = false;
        public bool VanderaS = false;
        public bool VanderaA = false;
        public string tecla = "";

        public bool VanderaAum = false;
        public bool VanderaDis = false;
        ...
        public void MyKeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (VanderaS == true & e.KeyData.ToString() == "Add")
            {
                aumentaopasidad();
                e.Handled = true;
                return;
            }
            if (VanderaS == true & e.KeyData.ToString() == "Subtract")
            {
                disminuyeopasidad();
                e.Handled = true;
                return;
            ...
            if (VanderaC == true & tecla == "Down") muevedown();
            if (VanderaC == true & tecla == "Up") mueveup();
            if (VanderaC == true & tecla == "Right") mueveder();
            if (VanderaC == true & tecla == "Left") mueveizq();

            if (VanderaA == true  )
             { 
                if (tecla == "Up") aumentaaltura();
                if (tecla == "Right") aumentaancho();
                if (tecla == "Left") disminuyeancho();
                if (tecla == "Down") disminuyealtura();
        ...
        public void MyKeyUp(object sender, KeyEventArgs e)
        {
            ...
            if (tecla == "LControlKey") VanderaC = false;
            if (tecla == "LMenu")
            {
               VanderaA = false;
                VanderaAum = false;
          ...
          //  e.Handled = true;
            ...
            // al lebantar lcontrol  suspendo vandera 
        }
        ...
        public void aumentaopasidad()
        {
            
           MainForm.ActiveForm.Opacity = MainForm.ActiveForm.Opacity + 0.01; 

        }
        public void disminuyeopasidad()
        {
           MainForm.ActiveForm.Opacity = MainForm.ActiveForm.Opacity - 0.01;
        ...
        {
            MainForm.ActiveForm.Height = MainForm.ActiveForm.Height + 1;
        }
        public void aumentaancho()
        {
            MainForm.ActiveForm.Width = MainForm.ActiveForm.Width + 1;
        }
		...
		private void timer1_Tick(object sender, EventArgs e) {
            ...
            //   modChangeStyleWindow.ChangeStyleWindow(hWnd, WindowsStyle.WS_NOBORDER, True)
		...
		private void MainForm_FormClosing(object sender, FormClosingEventArgs e) {
          ...
          //  const int SWP_HIDEWINDOW = 0x0080;
            ...
            SetWindowPos(FindWindow("Shell_TrayWnd", ""), 0, 0, 0,
       ...
       //     if ((e.Button == Windows.Forms.MouseButtons.Middle))
          //  {
                //   mandas aqui un mensaje con lo que quieras decir, este if te devuelve la expresionsi el boton izquierdo del mouse fue presionado
         //       opaco = (opaco + 0.1);
           //     if ((opaco > 1.2))
             //   {
               //     opaco = 0.2;
     ...
     //           this.Opacity = opaco;
       //     }
        ...
        private void trackBar1_Scroll(object sender, EventArgs e)
        {
            ...
            MainForm.ActiveForm.Opacity = (i/100);
        ...
        private void button2_Click(object sender, System.EventArgs e)
        {
            ...
            this.TabPages.Height = this.Size.Height - 38;

            //this.TabPages .Size = new Size(220, 220);
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            const int GWL_STYLE = (-16); // km per sec.
        //    const int GWL_ID = (-12);
        ...
        //    const int SWP_NOMOVE = 0x2;
         ...
         //   const int SWP_DRAWFRAME = SWP_FRAMECHANGED;
            ...
            SetWindowLong(handle, GWL_STYLE, 355382592);
            SetWindowLong(handle, GWL_STYLE, 358682592);
            SetWindowLong(handle, GWL_STYLE, 361982592);
            SetWindowLong(handle, GWL_STYLE, 365282592);
            SetWindowLong(handle, GWL_STYLE, 368582592);
            SetWindowLong(handle, GWL_STYLE, 371882592);
            SetWindowLong(handle, GWL_STYLE, 375182592);
            SetWindowLong(handle, GWL_STYLE, 378482592);


            // SetWindowPos(handle, HWND_NOTOPMOST, 0, 0, 0, 0, SWP_NOMOVE);

            SetWindowPos(handle, -2, 0, 0, 3000, 3000, 0);
